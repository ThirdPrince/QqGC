...
public class FavoritesListActivity extends BaseActivity {
  ...
  /*  private RefreshLayout refreshLayout ;
    ...
    {
        OkHttpManager.getInstance().getCollectionDataList(pageNo+"", pageSize+"", new NetCallBack() {
            @Override
                ...
                try {
                    ...
                    mainInfoPageAdapter.setOnItemClickListener(new MultiItemTypeAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, RecyclerView.ViewHolder holder, int position) {
                            ...
                            ArticleDetailActivity.startActivity(FavoritesListActivity.this,articleInfo.getId()+"");
                        }
