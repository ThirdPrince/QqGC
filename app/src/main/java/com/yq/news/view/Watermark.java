...
public class Watermark {
    ...
    public void show(Activity activity, String text) {
        ...
        params.setMargins(0,ConvertUtils.sp2px(120),0,ConvertUtils.sp2px(10));
        layout.setLayoutParams(params);
        layout.setBackground(drawable);
        rootView.addView(layout);
    }

    public void show(Fragment fragment, String text) {
        WatermarkDrawable drawable = new WatermarkDrawable();
        drawable.mText = text;
        drawable.mTextColor = mTextColor;
        drawable.mTextSize = mTextSize;
        ...
        ViewGroup rootView = fragment.getActivity().findViewById(android.R.id.content);
    ...
    public void show(View view, String text) {
        ...
        FrameLayout.LayoutParams params =  new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT);
        params.setMargins(0,ConvertUtils.sp2px(50),0,ConvertUtils.sp2px(10));
        layout.setLayoutParams(params);
        layout.setBackground(drawable);
        rootView.addView(layout);
    }
